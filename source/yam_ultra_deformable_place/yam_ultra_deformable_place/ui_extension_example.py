...
def some_public_function(x: int):
    print("[yam_ultra_deformable_place] some_public_function was called with x: ", x)
    return x**x
...
class ExampleExtension(omni.ext.IExt):
    ...
    def on_startup(self, ext_id):
        print("[yam_ultra_deformable_place] startup")
    ...
    def on_shutdown(self):
        print("[yam_ultra_deformable_place] shutdown")